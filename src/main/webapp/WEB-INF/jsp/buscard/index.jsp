...
hr{border:none;border-top:solid 1px #eee;height:7px;overflow:hidden;margin:0;}
</style>
  ...
  <body style="background:#efefef;">
	...
	<div class="container">
		<div class="border-radius" style="padding:10px;background:#fff;margin-bottom:30px">
			...
			<hr/>
			<div>
				<span style="line-height:30px;"><a href="${contextPath}buscard/listCard.do">有效卡数量：23</a></span>  
				
				<div class="pull-right" style="padding-top:0px;">
				
				<span style="line-height:30px;"><a href="${contextPath}buscard/listCard.do">累计售卡数量：58</a></span>  
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
	...
	<div style="padding:15px;">
		<button name="btn-create" class="btn btn-success btn-block" onclick="location.href='${contextPath}buscard/createCard.do'">添加新卡</button>
	</div>
	</div>
